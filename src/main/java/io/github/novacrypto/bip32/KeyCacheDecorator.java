...
public final class KeyCacheDecorator<Node> implements Derivation.Visitor<Node> {

    public static <Node> Derivation.Visitor<Node> newCacheOf(final Derivation.Visitor<Node> decorated) {

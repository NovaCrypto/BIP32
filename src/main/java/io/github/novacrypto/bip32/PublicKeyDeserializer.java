...
public final class PublicKeyDeserializer implements Deserializer<PublicKey> {
    ...
    @Override
    public PublicKey deserialize(final CharSequence extendedBase58) {
        return deserialize(base58Decode(extendedBase58));
    }

    @Override
    public PublicKey deserialize(final byte[] extendedBase58) {
